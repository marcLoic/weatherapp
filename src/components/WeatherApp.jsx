...
const WeatherApp = () => {
  ...
  const daysofWeek = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Say"]
    ...
    <div className="container" style={{ backgroundImage }}>
      ...
      style={{ backgroundImage: backgroundImage && 
                backgroundImage.replace ? 
                  backgroundImage.replace("ro right", "to top") :  null}}>
        ...
        {data.notFound ?
          (loading ? (<img className="loader" src={loadingGif} alt="loading"/>) : <div className="not-found">Not Found 😒</div>) : (
            <>
